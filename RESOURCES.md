...
* [Mathlib documentation](https://leanprover-community.github.io/mathlib4_docs/index.html) — official docs for the [Mathlib library](https://github.com/leanprover-community/mathlib4)
...
* Kevin Buzzard: [The rise of formalism in mathematics](https://www.youtube.com/watch?v=SEID4XYFN7o) (ICM 2022)

## Interactive

* [Lean Game Server](https://adam.math.hhu.de) — inspired many of the smaller exercises in this course
